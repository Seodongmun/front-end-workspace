...
let style3 = { color: "black", border: "2px solid" };
...
// 3. Sideways 메서드
// sidblings(['선택자']) : 선택된 요소와 같은 레벨에 있는 모든 요소를 선택하거나 매개변수가 있으면 같은 레벨 요소 중 매개변수와 일치하는 요소 선택
...
// h2 요소 이후부터 p 요소 이전에 모든 형제 요소에 테두리를 : 2px dashed
